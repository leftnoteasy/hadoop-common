...
/**
 * almost same to ClientServiceDelegate, but have URMDelegate instead of
 * ResourceMgrDelegate, change a little of getProxy
 */
public class URMClientServiceDelegate {
  ...
  public URMClientServiceDelegate(Configuration conf, URMDelegate rm,
